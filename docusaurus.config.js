...
const config = {
  ...
  organizationName: 'trandanhhoang', // Usually your GitHub org/user name.
  projectName: 'trandanhhoang.github.io', // Usually your repo name.
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          // },
          {
            title: 'Contact me: danhhoang5920@gmail.com',
            items: [
              {
                label: 'GitHub',
                href: 'https://github.com/trandanhhoang',
              },
            ],
          },
          // {
